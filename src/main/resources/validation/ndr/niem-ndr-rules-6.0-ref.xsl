...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M10">
   ...
   <!--RULE -->
   <xsl:template match="xs:simpleType" priority="1000" mode="M19">
   ...
   <!--PATTERN rule_9-11No simple type disallowed derivation-->
   <!--RULE -->
   <xsl:template match="xs:simpleType" priority="1000" mode="M20">

		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@final)"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-11: An element xs:simpleType MUST NOT have an attribute {}final.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-13No use of "fixed" on simple type facets-->
   <!--RULE -->
   <xsl:template match="xs:*[self::xs:length or self::xs:minLength or self::xs:maxLength or self::xs:whiteSpace      or self::xs:maxInclusive or self::xs:maxExclusive or self::xs:minExclusive or self::xs:minInclusive      or self::xs:totalDigits or self::xs:fractionDigits]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-13: A simple type constraining facet MUST NOT have an attribute {}fixed.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-30Complex content uses extension-->
   <!--RULE -->
   <xsl:template match="xs:complexContent" priority="1000" mode="M39">

		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(xs:extension)"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-30: An element xs:complexContent MUST have a child xs:extension.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-33Simple content uses extension-->
   <!--RULE -->
   <xsl:template match="xs:simpleContent" priority="1000" mode="M41">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-33: A complex type definition with simple content schema component MUST have a derivation method of extension.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-34No complex type disallowed substitutions-->
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M42">

		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@block)"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-34: An element xs:complexType MUST NOT have an attribute {}block.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-35No complex type disallowed derivation-->
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M43">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-35: An element xs:complexType MUST NOT have an attribute {}final.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M44">
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M48">
   ...
   <!--RULE -->
   <xsl:template match="xs:element[@type]" priority="1000" mode="M49">
   ...
   <!--PATTERN rule_9-43No element disallowed substitutions-->
   <!--RULE -->
   <xsl:template match="xs:element" priority="1000" mode="M50">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-43: An element xs:element MUST NOT have an attribute {}block.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-44No element disallowed derivation-->
   <!--RULE -->
   <xsl:template match="xs:element" priority="1000" mode="M51">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-44: An element xs:element MUST NOT have an attribute {}final.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-47Element declaration is nillable-->
   <!--RULE -->
   <xsl:template match="xs:element[@name and (empty(@abstract)                                           or xs:boolean(@abstract) = false())]"
                 priority="1000"
                 mode="M54">

		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(@nillable)                      and xs:boolean(@nillable) = true()"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-47: An element declaration MUST have the {nillable} property with a value of true.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M57">
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M63">
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute" priority="1000" mode="M65">
   ...
   <!--RULE -->
   <xsl:template match="xs:notation" priority="1000" mode="M66">
   ...
   <!--RULE -->
   <xsl:template match="xs:all" priority="1000" mode="M67">
   ...
   <!--RULE -->
   <xsl:template match="xs:sequence" priority="1000" mode="M68">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-62: An element xs:sequence MUST be a child of element xs:extension.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-64No xs:choice-->
   <!--RULE -->
   <xsl:template match="xs:choice" priority="1000" mode="M69">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-64: The schema MUST NOT contain the element xs:choice</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:sequence" priority="1000" mode="M71">
   ...
   <!--PATTERN rule_9-70No use of xs:any-->
   <!--RULE -->
   <xsl:template match="xs:any" priority="1000" mode="M72">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-70: The schema MUST NOT contain the element xs:any.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-71No use of xs:anyAttribute-->
   <!--RULE -->
   <xsl:template match="xs:anyAttribute" priority="1000" mode="M73">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-71: The schema MUST NOT contain the element xs:anyAttribute.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:unique" priority="1000" mode="M74">
   ...
   <!--RULE -->
   <xsl:template match="xs:key" priority="1000" mode="M75">
   ...
   <!--RULE -->
   <xsl:template match="xs:keyref" priority="1000" mode="M76">
   ...
   <!--RULE -->
   <xsl:template match="xs:group" priority="1000" mode="M77">
   ...
   <!--RULE -->
   <xsl:template match="xs:attributeGroup[@name]" priority="1000" mode="M78">
   ...
   <!--RULE -->
   <xsl:template match="node()[comment()]" priority="1000" mode="M79">
   ...
   <!--RULE -->
   <xsl:template match="xs:documentation/node()" priority="1000" mode="M80">
   ...
   <!--RULE -->
   <xsl:template match="xs:appinfo/node()" priority="1000" mode="M81">
   ...
   <!--RULE -->
   <xsl:template match="xs:appinfo/*" priority="1000" mode="M82">
   ...
   <!--RULE -->
   <xsl:template match="xs:appinfo//xs:*" priority="1000" mode="M83">
   ...
   <!--PATTERN rule_9-86No disallowed substitutions-->
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M87">

		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@blockDefault)"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-86: An element xs:schema MUST NOT have an attribute {}blockDefault.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_9-87No disallowed derivations-->
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M88">

		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@finalDefault)"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-87: An element xs:schema MUST NOT have an attribute {}finalDefault.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:redefine" priority="1000" mode="M89">
   ...
   <!--RULE -->
   <xsl:template match="xs:include" priority="1000" mode="M90">
   ...
   <!--RULE -->
   <xsl:template match="xs:import" priority="1000" mode="M91">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@type]" priority="1000" mode="M92">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@base]" priority="1000" mode="M93">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@itemType]" priority="1000" mode="M94">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@memberTypes]" priority="1000" mode="M95">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@ref]" priority="1000" mode="M96">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@substitutionGroup]" priority="1000" mode="M97">
   ...
   <!--PATTERN rule_10-13External attribute use only in external adapter type-->
   <!--RULE -->
   <xsl:template match="xs:attribute[some $ref-namespace in namespace-uri-from-QName(resolve-QName(@ref, .)),                                       $import in ancestor::xs:schema[1]/xs:import satisfies (                                    xs:anyURI($import/@namespace) = $ref-namespace                                    and exists($import/@appinfo:externalImportIndicator))]"
                 priority="1000"
                 mode="M103">

		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(ancestor::xs:complexType[1]/@appinfo:externalAdapterTypeIndicator)"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 10-13: An external attribute use MUST be in an external adapter type.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M110">
   ...
   <!--PATTERN rule_10-23Augmentable type has augmentation point element-->
   <!--RULE -->
   <xsl:template match="xs:complexType[                       @name[not(ends-with(., 'MetadataType'))                             and not(ends-with(., 'AugmentationType'))]                       and empty(@appinfo:externalAdapterTypeIndicator)                       and xs:complexContent]"
      ...
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="xs:complexContent/xs:extension/xs:sequence/xs:element[                        @ref[resolve-QName(., ..) = $augmentation-point-qname]]"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 10-23: An augmentable type MUST contain an element use of its corresponding augmentation point element.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_10-29Augmentation point element use is optional-->
   <!--RULE -->
   <xsl:template match="xs:complexType//xs:element[exists(@ref[                           matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]"
                 priority="1000"
                 mode="M117">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 10-29: An augmentation point element particle MUST have attribute minOccurs equal to 0.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN rule_10-30Augmentation point element use is unbounded-->
   <!--RULE -->
   <xsl:template match="xs:complexType//xs:element[exists(@ref[                           matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]"
                 priority="1000"
                 mode="M118">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 10-30: An augmentation point element particle MUST have attribute maxOccurs set to unbounded.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M122">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M124">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M125">
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M126">
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute" priority="1002" mode="M127">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M127">
   ...
   <!--RULE -->
   <xsl:template match="*[exists(@appinfo:deprecated)]" priority="1000" mode="M128">
   ...
   <!--RULE -->
   <xsl:template match="appinfo:LocalTerm" priority="1000" mode="M131">
   ...
   <!--RULE -->
   <xsl:template match="appinfo:LocalTerm" priority="1000" mode="M132">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M135">
   ...
   <!--RULE -->
   <xsl:template match="xs:simpleType[@name]" priority="1000" mode="M136">
   ...
   <!--RULE -->
   <xsl:template match="xs:list[exists(@itemType)]" priority="1000" mode="M137">
   ...
   <!--RULE -->
   <xsl:template match="xs:union[exists(@memberTypes)]" priority="1000" mode="M138">
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M142">
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M143">
   ...
   <!--RULE -->
   <xsl:template match="xs:element[@name]" priority="1000" mode="M144">
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M147">
      <xsl:variable name="namespace"
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M148">
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[@ref]" priority="1000" mode="M150">
      <xsl:variable name="namespace"
                    select="namespace-uri-from-QName(resolve-QName(@ref, .))"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attributeGroup[@ref]" priority="1000" mode="M151">
   ...
   <!--RULE -->
   <xsl:template match="xs:documentation" priority="1000" mode="M152">
      <xsl:variable name="xml-lang-attribute"
                    select="ancestor-or-self::*[exists(@xml:lang)][1]/@xml:lang"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:import" priority="1000" mode="M172">
